...
(function () {
  ...
  /** Sprachmenü unten auf der Seite (gleiche Bauart wie das Stil-Menü). */
  function picker() {
    const dd = window.VG_UI.dropdown({ title: t('Sprache'), options: LANGS, value: state.lang, onPick: setLang });
    document.addEventListener('vg-lang', (e) => dd.set(e.detail.lang, t('Sprache')));
    return dd.el;
  }
