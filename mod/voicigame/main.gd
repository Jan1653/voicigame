...
const VERSION := "0.9.1"   # bei jeder Mod-Änderung erhöhen (Voicitool zeigt sie an): Fehler 0.2.x, Neues 0.x.0
...
func _open_join() -> void:
	...
	_join.setup(bridge.server_url, VERSION)
